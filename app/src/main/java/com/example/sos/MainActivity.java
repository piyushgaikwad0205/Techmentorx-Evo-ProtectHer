...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadProfileImage() {
        android.view.View cardProfile = findViewById(R.id.cardProfileTop);
        if (cardProfile != null) {
            cardProfile.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, ProfileActivity.class)));
        }

        ImageView ivProfile = findViewById(R.id.ivProfileTop);
        if (ivProfile != null) {
            java.io.File localFile = new java.io.File(getFilesDir(), "profile_pic.jpg");
            if (localFile.exists()) {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent != null && "CANCEL_SOS".equals(intent.getAction())) {
            showBiometricPrompt();
        }
    }
    ...
    // Removed duplicate onOptionsItemSelected
